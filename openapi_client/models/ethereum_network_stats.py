...
class EthereumNetworkStats(BaseModel):
    ...
    """
    network_gross_apy: Optional[StrictFloat] = Field(None, description="Gross annual percentage yield")
    supply_staked_percent: Optional[StrictFloat] = Field(None, description="Supply of Ethereum currently staked")
