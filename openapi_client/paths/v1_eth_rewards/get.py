        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EthereumReward']:
                        return EthereumReward
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['EthereumReward'], typing.List['EthereumReward']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'EthereumReward':
                    return super().__getitem__(i)
            __annotations__ = {
                "data": data,
            }
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_ethereum_rewards_oapg(
        self,
...
class GetEthereumRewards(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_ethereum_rewards(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_ethereum_rewards(
        ...
        return self._get_ethereum_rewards_oapg(
