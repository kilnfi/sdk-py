...
class AccountsResponse(BaseModel):
    ...
    """
    accounts: Optional[conlist(Dict[str, Any])] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountsResponse:
        """Create an instance of AccountsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccountsResponse.parse_obj(obj)

        _obj = AccountsResponse.parse_obj({
