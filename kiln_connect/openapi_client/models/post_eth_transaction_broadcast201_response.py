...
class PostEthTransactionBroadcast201Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostEthTransactionBroadcast201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostEthTransactionBroadcast201Response:
        """Create an instance of PostEthTransactionBroadcast201Response from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PostEthTransactionBroadcast201Response.parse_obj(obj)

        _obj = PostEthTransactionBroadcast201Response.parse_obj({
