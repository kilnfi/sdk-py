...
class EthereumReward(BaseModel):
    ...
    """
    time: Optional[date] = Field(None, description="Day for this reward entry")
    ...
    gross_apy: Optional[StrictFloat] = Field(None, description="Gross annual percentage yield")
    cl_apy: Optional[StrictFloat] = Field(None, description="Consensus annual percentage yield")
    el_apy: Optional[StrictFloat] = Field(None, description="Execution annual percentage yield")
    __properties = ["time", "consensus_rewards", "execution_rewards", "rewards", "stake_balance", "gross_apy", "cl_apy", "el_apy"]
