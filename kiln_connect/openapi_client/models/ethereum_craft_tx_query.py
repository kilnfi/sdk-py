...
class EthereumCraftTxQuery(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EthereumCraftTxQuery:
        """Create an instance of EthereumCraftTxQuery from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EthereumCraftTxQuery:
        """Create an instance of EthereumCraftTxQuery from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EthereumCraftTxQuery.parse_obj(obj)

        _obj = EthereumCraftTxQuery.parse_obj({
